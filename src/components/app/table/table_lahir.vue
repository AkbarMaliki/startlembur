              ...
              <tr>
                ...
                <td>
                  <div class="sm-form">
                    <input
                      type="text"
                      placeholder="Lahir ID"
                      id="LahirID"
                      name="LahirID"
                      class="form-control form-control-sm"
                      v-model="vdata.LahirID"
                      disabled
                    />
                  </div>
                </td>
            ...
            <thead class="mdb-color bg-black">
              <tr class="text-white" style="overflow:scroll;color:white;">
                ...
                <th
                  ...
                  :key="index+'th'"
                  v-show="item!='LahirID' && item!='PendudukID' && item!='PerangkatID' && item!='tgl1' && item!='Alamat' && item!='NamaAyah' && item!='NamaIbu'"
                >
              ...
              <tr v-for="(item, index3) in td" :key="index3+'td'">
                ...
                <no-ssr>
                  <v-touch
                    ...
                    :key="indexs+'th2'"
                    v-html="item[item2]"
                    v-show="item2!='LahirID' && item2!='PendudukID' && item2!='PerangkatID' && item2!='tgl1' && item2!='Alamat' && item2!='NamaAyah' && item2!='NamaIbu'"
                  ></v-touch>
                </no-ssr>
              </tr>
            </tbody>
...
export default {
  ...
  methods: {
    pilihPenduduk(ev) {
      ...
      axios
        ...
        .then(res => {
          ...
          this.vdata.TglLahir = hasil[0].TGL_LHR;
          this.vdata.JenisKelamin = hasil[0].JenisKelamin == "L" ? "L" : "P";
    ...
    editData() {
      ...
      fd.append("data[LahirID]", this.vdata.LahirID);
      ...
      fd.append("data[TglLahir]", this.vdata.TglLahir);
      ...
      fd.append("data[NamaAyah]", this.vdata.NamaAyah);

      fd.append("data[NamaIbu]", this.vdata.NamaIbu);
