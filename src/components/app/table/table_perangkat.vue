  ...
  <div>
      ...
      <div class="row" id="top1">
        <div class="col-sm-3">
          <template v-if="formOn">
            <div>
              <div v-if="editOn" style="font-family:times new roman;">
                Edit Data
              ...
              <div v-else style="font-family:times new roman;">
                Tambah Data
    ...
    <template v-if="formOn">
      <div>
        ...
        <p
          v-if="err"
          class="p-1 pl-3 bg-red rounded-lg mb-2"
          style="color:white;"
        >Data yang dimasukkan tidak lengkap !</p>
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <tr>
              ...
              <tr>
                ...
                <td>&nbsp;:&nbsp;</td>
                <td>
                  <input type="radio" id="one" name="JK" value="Laki - Laki" v-model="vdata.JK" />
                  <label for="one">Laki - Laki</label>
                  <br />
                  <input type="radio" id="one" name="JK" value="Perempuan" v-model="vdata.JK" />
            ...
            <div class="col-sm-6">
              ...
              <tr>
                ...
                <td>
                  <div class="sm-form">
                    <input
                      type="text"
                      placeholder="Pend Terakhir"
                      id="PendTerakhir"
                      name="PendTerakhir"
                      class="form-control form-control-sm"
                      v-model="vdata.PendTerakhir"
                    />
                  </div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <div class="sm-form">
                    <input
                      type="text"
                      placeholder="No Pengangkatan"
                      id="NoPengangkatan"
                      name="NoPengangkatan"
                      class="form-control form-control-sm"
                      v-model="vdata.NoPengangkatan"
                    />
                  </div>
                </td>
              </tr>
              ...
              <tr>
                <td>Tgl Pengangkatan</td>
                <td>&nbsp;:&nbsp;</td>
                <td>
                  <div class="sm-form">
                    <input
                      type="text"
                      placeholder="Tgl Pengangkatan"
                      id="TglPengangkatan"
                      name="TglPengangkatan"
                      class="form-control form-control-sm"
                      v-model="vdata.TglPengangkatan"
                    />
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="tips">
                    ...
                    <span class="tipstextB">Klik Upload</span>
                  </div>
                  <img
                    v-if="vdata.Gambar"
                    :src="$store.state.url+vdata.Gambar"
            ...
            <template v-if="modalAction=='preview'">
              ...
              <table class="font-times text-sm sm:text-lg">
                <tr v-for="(item, key,index) in pilih" :key="index">
                  ...
                  <td>&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</td>
                  <td :class="{'float-right':key=='Gambar'}">
                    <template v-if="key=='Gambar'">
                      <div>
                        <img
                          :src="$store.state.url+item"
                          class="kinoLightBox img-fluid rounded-top z-depth-2"
                          style="height:150px;"
                          alt="no found"
                        />
...
export default {
  ...
  methods: {
    ...
    editData() {
      ...
      fd.append(
        "data",
        `UPDATE bamban_tbperangkat SET Nama='${this.vdata.Nama}',NIP='${this.vdata.NIP}',JK='${this.vdata.JK}',TempatLahir='${this.vdata.TempatLahir}',TglLahir='${this.vdata.TglLahir}',Agama='${this.vdata.Agama}',Pangkat='${this.vdata.Pangkat}',Jabatan='${this.vdata.Jabatan}',PendTerakhir='${this.vdata.PendTerakhir}',NoPengangkatan='${this.vdata.NoPengangkatan}',TglPengangkatan='${this.vdata.TglPengangkatan}',Gambar='${this.vdata.Gambar}' Where UrutID = '${this.vdata.UrutID}'`
      );
      if (
        this.vdata.Nama &&
        this.vdata.NIP &&
        this.vdata.JK &&
        this.vdata.TempatLahir &&
        this.vdata.TglLahir &&
        this.vdata.Agama &&
        this.vdata.Pangkat &&
        this.vdata.Jabatan &&
        this.vdata.PendTerakhir &&
        this.vdata.NoPengangkatan &&
        this.vdata.TglPengangkatan
      ) {
        this.err = false;
        this.$nuxt.$emit("busy", true);
        axios
          .post(this.$store.state.url + "/api/mysql/auto", fd, {
            headers: {
    ...
    saveData() {
      ...
      fd.append(
        "data",
        `Insert into bamban_tbperangkat (Nama,NIP,JK,TempatLahir,TglLahir,Agama,Pangkat,Jabatan,PendTerakhir,NoPengangkatan,TglPengangkatan,Gambar) VALUES ('${this.vdata.Nama}','${this.vdata.NIP}','${this.vdata.JK}','${this.vdata.TempatLahir}','${this.vdata.TglLahir}','${this.vdata.Agama}','${this.vdata.Pangkat}','${this.vdata.Jabatan}','${this.vdata.PendTerakhir}','${this.vdata.NoPengangkatan}','${this.vdata.TglPengangkatan}','${this.vdata.Gambar}')`
      );
      if (
        this.vdata.UrutID &&
        this.vdata.Nama &&
    ...
    deleteData() {
      ...
      fd.append(
        "data",
        `DELETE FROM bamban_tbperangkat WHERE  UrutID =  '${this.vdata.UrutID}'`
      );
      this.$nuxt.$emit("busy", true);
      axios
        .post(this.$store.state.url + "/api/mysql/auto", fd, {
    ...
    ambil(item, index) {
      ...
      this.editOn = true;
      this.formOn = true;
      let clone = this.$_.clone(item); // item vue object
    ...
    refreshData() {
      ...
      fd2.append("data", "select * from bamban_tbperangkat"); // if empty = *
      axios
        .post(this.$store.state.url + "/api/mysql/auto", fd2, {
          headers: {
            Authorization: localStorage.getItem("auth.local")
          }
        })
    ...
    print() {
      this.$store.state.prints = this.pilih;
      this.$router.push("/print/perangkat");
    },
    printy() {
      this.$store.state.prints = this.datanya;
      this.$router.push("/print/laporan_perangkat");
    },
    sort(item) {
      this.orderBy = item;
  ...
  mounted() {
    this.$nuxt.$on("ambilGambar", data => {
      console.log(data);
      this.vdata.Gambar = data;
