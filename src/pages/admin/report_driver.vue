    ...
    >
     <div class="card">
      ...
      <!-- FORM --> 
          ...
          <tr>
              <td class='text-uppercase text-sm'>unit_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>emails_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>nohp_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
        ...
        <div class="w-full sm:w-1/3">
          <div class="row">
            <div class="col-3 order-2">
              <a :href="`https://akbarmaliki.github.io/infolayanansjs/#/excel?data=${JSON.stringify(td).split('&').join('%26')}`" class="btn-lg btn-success" ><span class="typcn typcn-chart-bar"></span></a>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      // valdatable
      datanya: [],
      order:['id','nip','nama','unit','email','nohp'],
      vdata: {
  ...
  methods: {
    insert(){
       ...
       refreshData() {
         let that = this
         db.collection(`users`).where('unit.nama_unit','==','DRIVER').onSnapshot(snap=>{
             let arr = []
             snap.forEach(e=>{
    ...
    checkedAll() {
     ...
     susun(datas){
      let that=this
      let data = datas;
      let order = ['id','nip','nama','unit','emails','nohp']
      let hasil=[]
      let obj={}
