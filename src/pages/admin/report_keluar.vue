<template>
  <div class="font-times">
    ...
    >
     <div class="card">
        <div class="card-header">users/${this.$store.state.users.uid}/history-keluar</div>
        <div class="card-body">
      <!-- FORM --> 
          <tr>
          ...
          <tr>
              <td class='text-uppercase text-sm'>nip_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>nama_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>jam_berangkat_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="jam_berangkat_"
                    id="jam_berangkat"
                    name="jam_berangkat"
                    class="form-control form-control-sm"
                    v-model="vdata.jam_berangkat"
                    pattern="[a-zA-Z0-9\s]+" minlength="0" maxlength="30"
                    oninvalid="this.setCustomValidity('Harus diisi dan Maksimal 30 !')"
              oninput="this.setCustomValidity('')"
              required
          ...
          <tr>
              <td class='text-uppercase text-sm'>rincian_kerja_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="rincian_kerja_"
                    id="rincian_kerja"
                    name="rincian_kerja"
                    class="form-control form-control-sm"
          ...
          <tr>
              <td class='text-uppercase text-sm'>kendaraan_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="kendaraan_"
                    id="kendaraan"
                    name="kendaraan"
                    class="form-control form-control-sm"
                    v-model="vdata.kendaraan"
                    pattern="[a-zA-Z0-9\s]+" minlength="0" maxlength="30"
                    oninvalid="this.setCustomValidity('Harus diisi dan Maksimal 30 !')"
              oninput="this.setCustomValidity('')"
              required
          ...
          <tr>
              <td class='text-uppercase text-sm'>penumpang_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="penumpang_"
                    id="penumpang"
                    name="penumpang"
                    class="form-control form-control-sm"
                    v-model="vdata.penumpang"
                    pattern="[a-zA-Z0-9\s]+" minlength="0" maxlength="30"
                    oninvalid="this.setCustomValidity('Harus diisi dan Maksimal 30 !')"
              oninput="this.setCustomValidity('')"
              required
          ...
          <tr>
              <td class='text-uppercase text-sm'>lokasi_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>tujuan_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>createAt_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="createAt_"
                    id="createAt"
                    name="createAt"
                    class="form-control form-control-sm"
                    v-model="vdata.createAt"
                    pattern="[a-zA-Z0-9\s]+" minlength="0" maxlength="30"
                    oninvalid="this.setCustomValidity('Harus diisi dan Maksimal 30 !')"
              oninput="this.setCustomValidity('')"
              required
          ...
          <tr>
              <td class='text-uppercase text-sm'>bintang_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="bintang_"
                    id="bintang"
                    name="bintang"
                    class="form-control form-control-sm"
                    v-model="vdata.bintang"
                    pattern="[a-zA-Z0-9\s]+" minlength="0" maxlength="30"
                    oninvalid="this.setCustomValidity('Harus diisi dan Maksimal 30 !')"
              oninput="this.setCustomValidity('')"
              required
          ...
          <tr>
              <td class='text-uppercase text-sm'>pilih_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
          ...
          <tr>
              <td class='text-uppercase text-sm'>disposisi1_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="disposisi1_"
                    id="disposisi1"
                    name="disposisi1"
                    class="form-control form-control-sm"
          ...
          <tr>
              <td class='text-uppercase text-sm'>disposisi2_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="disposisi2_"
                    id="disposisi2"
                    name="disposisi2"
                    class="form-control form-control-sm"
          ...
          <tr>
              <td class='text-uppercase text-sm'>disposisi3_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="disposisi3_"
                    id="disposisi3"
                    name="disposisi3"
                    class="form-control form-control-sm"
                    v-model="vdata.disposisi3"
                    pattern="[a-zA-Z0-9\s]+" minlength="0" maxlength="30"
                    oninvalid="this.setCustomValidity('Harus diisi dan Maksimal 30 !')"
              oninput="this.setCustomValidity('')"
              required
...
export default {
  ...
  data() {
    return {
      ...
      // valdatable
      datanya: [],
      order:['id','nip','nama','jam_berangkat','rincian_kerja','kendaraan','penumpang','lokasi','tujuan','createAt','bintang','pilih','disposisi1','disposisi2','disposisi3','driver','mobil'],
      vdata: {
  ...
  methods: {
    insert(){
          ...
          db.collection(`users/${this.$store.state.users.uid}/history-keluar`).doc().set(this.vdata).then(res=>{
              console.log('berhasil')
              alert('simpan data berhasil!')
          })
      },update(){
          db.collection(`users/${this.$store.state.users.uid}/history-keluar`).doc(this.pilih.id).set(this.vdata,{merge:true}).then(res=>{
              alert('update data berhasil!')
          })
      },remove(){
          if(confirm('Apakah yakin menghapus data?')){
              db.collection(`users/${this.$store.state.users.uid}/history-keluar`).doc(this.pilih.id).delete().then(res=>{
       ...
       refreshData() {
         let that = this
         db.collection(`users/${this.$store.state.users.uid}/history-keluar`).onSnapshot(snap=>{
             let arr = []
             snap.forEach(e=>{
          ...
          setTimeout(() => {
            ...
            arr.forEach((e,index)=>{
              that.order.forEach(e=>{
                if(e=='driver'){
                    obj[e]=arr[index][e].nama}
                else if(e=='mobil'){
                    obj[e]=arr[index][e].nama_mobil}
                else{
                    obj[e]=arr[index][e]
                  }
              })
    ...
    checkedAll() {
     ...
     susun(datas){
      let that=this
      let data = datas;
      let order = ['id','nip','nama','jam_berangkat','rincian_kerja','kendaraan','penumpang','lokasi','tujuan','createAt','bintang','pilih','disposisi1','disposisi2','disposisi3']
      let hasil=[]
      let obj={}
