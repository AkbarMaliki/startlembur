<template>
  <div>
    <!-- cara memakai 
        ...
        import upload from '@/components/Single/Uploader.vue'
    -->
    <div class="uploadContainer hoverable" style="padding:10px;">
      <div class="imgInputContainer" @click="upload" style="cursor:pointer;margin-left:0px;">
        ...
        <div class="teksPos">
          <span
            style="font-size:15px;position:absolute;margin-top:40px;color:gray;"
            class="fixZ"
            v-if="imgList.length==0"
          >CLICK/DRAG FILE</span>
          <span
            style="font-size:15px;position:absolute;margin-top:60px;color:gray;"
            class="fixZ"
            v-if="imgList.length==0"
